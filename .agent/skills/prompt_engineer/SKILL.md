...
**Action**:
1.  **Read File**: `c:\Users\daiki\Product\2nd-Brain\2nd-Brain\00_システム\01_Prompts\プロンプト生成\01_interviewer.md`
...
**Action**:
1.  **Read File**: `c:\Users\daiki\Product\2nd-Brain\2nd-Brain\.agent\skills\prompt_engineer\resources\examples.md`
    - **Goal**: Understand the "Gold Standard" quality and structure (Few-Shot Learning).
2.  **Read File**: `c:\Users\daiki\Product\2nd-Brain\2nd-Brain\00_システム\01_Prompts\プロンプト生成\02_architect.md`
    - Create **Draft Prompt**.
3.  **Read File**: `c:\Users\daiki\Product\2nd-Brain\2nd-Brain\00_システム\01_Prompts\プロンプト生成\03_auditor.md`
    - Create **Audit Report**.
...
1.  **Read File**: `c:\Users\daiki\Product\2nd-Brain\2nd-Brain\00_システム\01_Prompts\プロンプト生成\04_Prompt Refiner.md`
    - **Act**: Refine the prompt based on the previous audit/feedback.
2.  **Read File**: `c:\Users\daiki\Product\2nd-Brain\2nd-Brain\00_システム\01_Prompts\プロンプト生成\05_Simulation Runner.md`
    - **Act**: Simulate 3 test cases (Standard, Missing Info, Stress).
3.  **Read File**: `c:\Users\daiki\Product\2nd-Brain\2nd-Brain\00_システム\01_Prompts\プロンプト生成\06_Quality Gatekeeper.md`
